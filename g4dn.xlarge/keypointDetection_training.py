...
# Each label consists of 15 (x, y) coordinates (30 values)
...
Batch-normalization helps to smooth out the training.
...
The metrics we want to track is accuracy and mean absolute error.
Accuracy measures how well the model is doing, 100% would mean the model is perfect.
